...
const char* const colorname[] = {"aquamarine", "red", "green yellow", "magenta",
...
Triangle does.  The command syntax is:
...
A Brief Plea:
  ...
  please include an acknowledgment as well.
...
int load_node(char *fname, int *firstnumber, int *nodes, int *dim,
              REAL **ptr, REAL *xmin, REAL *ymin, REAL *xmax, REAL *ymax)
{
  FILE *infile;
...
int load_poly(int inc, char *fname, int *firstnumber, int *pnodes,
  int *dim, int *edges, int *holes,
  REAL **nodeptr, int **edgeptr, REAL **holeptr,
...
int load_part(char *fname, int dim, int firstnumber, int elems, REAL *nodeptr, int *eleptr,
  int *parts, int **partition, REAL **partcenter, REAL **partshift)
{
  FILE *infile;
  char inputline[INPUTLINESIZE];
  char *stringptr;
...
void draw_poly(int nodes, int dim, int edges, int holes,
               REAL *nodeptr, int *edgeptr, REAL *holeptr,
...
void draw_ele(int inc, int elems, int corners, int *ptr, int *partition,
              REAL *shift, REAL xscale, REAL yscale, REAL xoffset, REAL yoffset)
{
  int i, j;
  int index;
  REAL shiftx, shifty;
...
void draw_edge(int nodes, int dim, int edges,
               REAL *nodeptr, int *edgeptr, REAL *normptr,
               REAL xscale, REAL yscale, REAL xoffset, REAL yoffset)
{
  int i;
  int index;
...
void print_ele(FILE *elefile, int nodes, int dim, int elems, int corners,
               REAL *nodeptr, int *eleptr, int *partition, REAL *shift,
               REAL xscale, REAL yscale, REAL xoffset, REAL yoffset,
...
void print_edge(FILE *edgefile, int nodes, int dim, int edges,
                REAL *nodeptr, int *edgeptr, REAL *normptr,
                REAL xscale,REAL yscale, REAL xoffset,REAL yoffset,
                int llcornerx, int llcornery)
{
...
void print_adj(FILE *adjfile, int dim, int subdomains, int *ptr,
               REAL *center, REAL xscale, REAL yscale, REAL xoffset, REAL yoffset,
               int llcornerx, int llcornery)
{
  int i, j;
  REAL *point1, *point2;
